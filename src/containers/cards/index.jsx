...
const index = () => {
  return (
    <div className="container cards">
      <div className="img">
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQFooHXI8dHExHQFSIUHMJ_N7Ax7E2T81fR-SDjacsOZqZ_Wtxj01lVIbwBqGFnSACutlI&usqp=CAU"
          alt=""
        />
        <p>
      ...
      <div className="img">
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRkUIiz19FoSo_fSfIhkmxCiLma3BPQrYhKPg&usqp=CAU"
          alt=""
        />
        <p>
      ...
      <div className="img">
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRf_dP2XJVqC3S8GAwSmE2fDhWBOuJAs5_xcA&usqp=CAU"
          alt=""
        />
        <p>
